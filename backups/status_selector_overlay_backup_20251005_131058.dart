...
class _StatusSelectorOverlayState extends State<StatusSelectorOverlay>
  ...
  // Nueva especificación: Grid 3x4 de estados organizados
  final List<StatusType?> _statusGrid = [
    ...
    null, null, null, StatusType.sos, // null en posición 0 = settings, posiciones 1-2 = empty
  ];
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Container(
          color: Colors.black.withOpacity(0.85 * _fadeAnimation.value), // Más oscuro y transparente
          child: Center(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Colors.white.withOpacity(0.9), // Texto blanco transparente
                      ),
                    ),
                    ...
                    TextButton(
                      ...
                      child: Text(
                        'Cancelar',
                        style: TextStyle(
                          color: Colors.white.withOpacity(0.7), // Texto blanco transparente
                          fontSize: 16,
                        ),
                      ),
                    ),
              ...
              Flexible(
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Colors.white.withOpacity(0.8), // Texto blanco transparente
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 10,
                  color: Colors.blue.shade200, // Texto azul claro
                  fontWeight: FontWeight.w500,
                ),
              ),
            ],
